...
PHYADDER是PHY地址�?�?�?�?�?�?第一个以太网口为0
REGADDER为PHY的寄存器地址,一�?2个寄存器
*********************************************/
...
/*********************************************
通过SMI写取寄存器内�?
PHYADDER是PHY地址�?�?�?�?�?这里第一个以太网口为0
REGADDER为PHY的寄存器地址,写一�?6位数�?
*********************************************/
...
通过SMI读取寄存器内�?
PHYADDER是PHY地址�?�?�?�?�?这里第一个以太网口为0
REGADDER为PHY的寄存器地址,return一�?6位数�?
*********************************************/
